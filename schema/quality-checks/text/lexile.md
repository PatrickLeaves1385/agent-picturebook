...
## 变更记录
- **2026-07-06**：[自进化 prop-2026-07-06-002] target 上限 300 → 350，依据：用户反馈 demo 项目 300 太紧。
- **2026-07-06**：[修复 regression-001] 加 priority=project-overridable + target_source 字段，暴露项目级覆盖机制。
