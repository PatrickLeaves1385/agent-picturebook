...
禁止词表（文本侧权威词表，统一定义于 `content/basic-safety.md` 的 3 词表；emotion-tone 维度 2 直接复用，不再独立维护）：
- 词表 1 负面情绪 / 词表 2 恐怖元素 / 词表 3 阴暗元素（详见 basic-safety.md，含 scared/afraid/terrified/sad/crying/weep/angry/hate/hurt/pain/fight 等全量词）
